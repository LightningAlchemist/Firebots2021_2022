...
(cl:defmethod cl:initialize-instance :after ((m <Anchor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Anchor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_decawave-msg:<Anchor> is deprecated: use ros_decawave-msg:Anchor instead.")))
...
(cl:defmethod distance-val ((m <Anchor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_decawave-msg:distance-val is deprecated.  Use ros_decawave-msg:distance instead.")
  (distance m))

(cl:ensure-generic-function 'dist_qf-val :lambda-list '(m))
(cl:defmethod dist_qf-val ((m <Anchor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_decawave-msg:dist_qf-val is deprecated.  Use ros_decawave-msg:dist_qf instead.")
  (dist_qf m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Anchor>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'distance))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'dist_qf))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Anchor>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'dist_qf) (roslisp-utils:decode-double-float-bits bits)))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Anchor>)))
  ...
  "3c1d783d1e22339670e2979c9c5e3db4")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Anchor)))
  "Returns md5sum for a message object of type 'Anchor"
  "3c1d783d1e22339670e2979c9c5e3db4")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Anchor>)))
  ...
  (cl:format cl:nil "# Anchor message structure. qf is the quality of this measurement and dist_qf the quality of the estimated distance.~%~%Header header~%~%float64 x ## in m~%float64 y ## in m~%float64 z ## in m~%float64 qf ## in percent~%float64 distance ## in m~%float64 dist_qf ## in percent~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Anchor)))
  "Returns full string definition for message of type 'Anchor"
  (cl:format cl:nil "# Anchor message structure. qf is the quality of this measurement and dist_qf the quality of the estimated distance.~%~%Header header~%~%float64 x ## in m~%float64 y ## in m~%float64 z ## in m~%float64 qf ## in percent~%float64 distance ## in m~%float64 dist_qf ## in percent~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
