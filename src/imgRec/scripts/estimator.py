...
class Estimator:
    ...
    def __init__(self):
        ...
        rospy.Subscriber('rob_index', Int16, self.getPosition) # subscribe tag message
        ...
        self.redThreshold = 0.0007  # the threshold to determine if the grid is on fire
        ...
        self.index_position = -1  # linear index position to left end of strip
    ...
    def decayBelief(self):
        ...
        previous_belief = self.estimated_state[:]   # deep copy of current belief at time = t
